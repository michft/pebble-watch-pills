...
function settingsSection(settings, appearance) {
  ...
  return "<section class=card><h2>Phone appearance</h2>"
    ...
    + "<fieldset><legend>Watchface</legend><label for=use-digits>Time display</label>"
    + "<select id=use-digits>" + options([[0, "Words"], [1, "Digits"]], display.useDigits === true ? 1 : 0) + "</select>"
